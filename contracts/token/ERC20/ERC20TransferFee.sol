...
/**
 * @title Transfer Fee ERC20 token
 *
 ...
 */
contract ERC20TransferFee is IERC20 {
    ...
    event FeesWithdrawn(address indexed to, uint256 value);
     ...
     */
    function transferFee() public pure returns (uint8) {
        return _transferFee;
    }
    ...
    /**
     * @return the manager of the token fees.
     */
    ...
    /**
     * @dev Function to pay fee
     * @param value The amount of tokens to pay fee for.
